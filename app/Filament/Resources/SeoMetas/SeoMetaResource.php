...
class SeoMetaResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'SEO метатеги';

    protected static ?string $modelLabel = 'SEO метатег';

    protected static ?string $pluralModelLabel = 'SEO метатеги';
